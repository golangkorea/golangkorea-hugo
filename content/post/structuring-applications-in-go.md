...
3. 애플리케이션이 10,000라인이 넘어가기 시작하면 이 프로젝트를 더 작은 프로젝트들로 나눌 순 없는지를 심각하게 고민해보라.

[Bolt](https://github.com/boltdb/bolt)는 이에 대한 좋은 예제이다. 각 파일은 하나의 Bold 구조체와 관련 있는 타입들로 그룹핑된다:
